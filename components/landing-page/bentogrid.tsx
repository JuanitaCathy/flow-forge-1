    ...
    <div className="flex flex-col justify-center h-full items-center relative">
      ...
      <div className="text-left p-6 mt-4">
        ...
        <p className="text-gray-400 text-lg">
          Create and manage custom issue{" "}
          <span className="text-purple-500">templates</span> to standardize your
          ...
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="text-left p-6 mt-4">
              ...
              <p className="text-white/70 text-lg">
                Track your <span className="text-purple-500">team</span>'s
                productivity with automated PR reviews, issue management, and
          ...
          <CardWithEffect>
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="text-left p-6">
                ...
                <p className="text-white/70 text-lg">
                  Connect GitHub and Discord seamlessly using{" "}
                  <span className="text-purple-500">Kestra</span> for workflow
                  orchestration.
                </p>
              </div>
            </div>
